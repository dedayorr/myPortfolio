    ...
    <div className="h-">
      ...
      <div className="md:flex lg:mx-auto lg:justify-center">
        ...
        <div className="md:mt-[10%] lg:w-[50%] lg:mt-[10%]">
          <p className="mx-[2%] text-lg opacity-50 text-center lg:text-3xl">
            My name is Elijah Adedayo Adeyeye, and I am a skilled Front-End
            Developer with a track record of delivering exceptional results.{" "}
            <br />
            With my ability to collaborate effectively with other developers, I
            have proven experience in building scalable, responsive,
            user-friendly, and accessible websites. <br />I am proficient in
            HTML, CSS, JavaScript, as well as several libraries and frameworks
      ...
      <div className="flex text-center font-bold mt-[5%] md:justify-center gap-[5%] lg:text-2xl">
        <div className="flex space-x-3">
          <div className="text-[#CFB997]">
            <BsFillTelephoneFill />
          </div>
          <p> +234(912)756-3048</p>
        </div>
        <div className="flex space-x-3">
          <div className="text-[#CFB997]">
            <GrMail />
          </div>
          <p>dedayo16@gmail.com</p>
        </div>
      </div>
    </div>
  );
