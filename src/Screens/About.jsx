...
export const About = () => {
  return (
    <div className="h-">
      ...
      <p className="text-[#CFB997] font-bold text-3xl ml-2 mt-[10%] lg:ml-[10%] lg:text-5xl lg:mt-[7%]">Skills</p>
      ...
      <div className="">
        <p className="font-bold text-xl ml-2 mt-[10%] lg:ml-[10%] lg:text-4xl">Learning : </p>
